...
hold on
plot(tex(:,2),'b')
legend(' texon 1','texon 2','texton 1', 'texton 2','Location','SouthEast');
%title('Texton comparison with  points of similar texton in different region');
...
% saveas(textonfig,strcat(outputFileName,'_responsePlot'),'fig');
