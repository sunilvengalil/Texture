function results = traintest1(varargin)
...
for pass = 1:2
  ...
  opts.imdbPath = fullfile(opts.datasetDir,'imdb','imdb.mat');
...
elseif (strcmp(opts.featureType, 'fv+decaf'))
  ...
  descrs = encodeImage2(encoder, cellfun(@(S) fullfile(imdb.imageDir, S), ...
